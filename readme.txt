...
== Description ==
If you have coding skill and feel we have an issue with the plugin please send us an email. We could use your help to improve the plugin.
email: zigvt85@hotmail.com
...
Check the screenshot pages for previews.
...
* 2.4.2 - Fixed Widget that was or maybe causing errors. Works with with the latest WordPress and PHP. Tested on Windows 10 and Chrome Browser.
-Cleaned up widget coding made it up to date with the latest WordPress.