<?php
//////////////////////////////////////////////////////
//Tells PHP and WordPress it is a class format
class ryv_widget extends WP_Widget
{
    ...
    { 
        parent::__construct( false, "Random YT Video", array( 'description' => __('Displays a random YouTube video on your sidebar!', 'ryv_widget') ) );
    }
    //////////////////////////////////////////////////////
...
<?php
    //////////////////////////////////////////////////////
    //The main part of the form for the widget
	}
		echo $after_widget;
	}
